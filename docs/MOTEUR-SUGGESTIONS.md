...
| Événements / émeutes / **finales sportives** (conclave, **Journée des Tuiles**, **finale Coupe du monde des clubs FIFA** géotaggée au stade) | bad-types DIRECTS (émeute Q124757 ; **finale Q1366722 / finale foot Q65770283**, sous-classe de sporting-event Q16510064) + NOISE_BLOCK — test LOCAL avant le filtre lieu, donc immunisé contre son fail-open. **+ source de secours Wikipédia filtrée par le VRAI filtre lieu** (Q-id → place-filter, `e16e144`) | — |
